        ...
        function comidabusca(busqueda){
            ...
            doccomida.then(function(alimentos) {
                ...
                alimentos.forEach(function (doc) {
                    ...
                    if(JaroWrinker(cadena1,cadena2) > 0.7 || LevenshteinDistance(cadena1,cadena2) < 5){
                   ...
                   i = 0;
                    ...
                    contenidomodal += '                <img class="card-img-top img+fluid" id="img'+doc.id+'" src="" alt="Card image cap">';
                ...
                document.getElementById("Nuestrosfavoritos").innerHTML = favoritos;
                document.getElementById("NuestrosfavoritosModal").innerHTML = favoritosmodal;
    
                document.getElementById("Bebidasfrias").innerHTML = frias;
                document.getElementById("BebidasfriasModal").innerHTML = friasmodal;
    
                document.getElementById("Bebidascalientes").innerHTML = calientes;
                document.getElementById("BebidascalientesModal").innerHTML = calientesmodal;
    
                document.getElementById("Desayunodeautor").innerHTML = autor;
                document.getElementById("DesayunodeautorModal").innerHTML = autormodal;
    
                document.getElementById("Platillosdeescritor").innerHTML = escritor;
                document.getElementById("PlatillosdeescritorModal").innerHTML = escritormodal;
    
                document.getElementById("Menuliterario").innerHTML = literario;
                document.getElementById("MenuliterarioModal").innerHTML = literariomodal;
    
                document.getElementById("Postres").innerHTML = postres;
                document.getElementById("PostresModal").innerHTML = postresmodal;
    
                document.getElementById("Comidarapida").innerHTML = rapida;
                document.getElementById("ComidarapidaModal").innerHTML = rapidamodal;
    
                document.getElementById("Tortas").innerHTML = tortas;
                document.getElementById("TortasModal").innerHTML = tortasmodal;
    
                document.getElementById("Tacos").innerHTML = tacos;
                document.getElementById("TacosModal").innerHTML = tacosmodal;
    
                document.getElementById("Barrafria").innerHTML = barrafria;
                document.getElementById("BarrafriaModal").innerHTML = barrafriamodal;
    
                document.getElementById("Vegetariano").innerHTML = vegetariano;
                document.getElementById("VegetarianoModal").innerHTML = vegetarianomodal;
    
                document.getElementById("Todas").innerHTML = todo;
                document.getElementById("TodasModal").innerHTML = todomodal;
                ...
                var uri = ""+urlid[i];
                    ...
                    storageRef.child(uri).getDownloadURL().then(function(url) {
                        ...
                        var img2 = document.getElementById('img'+element);
            ...
            var urlid = [];
             doccomida.then(function(alimentos) {
                ...
                alimentos.forEach(function (doc) {
                    var banderas = "";
                    banderas = doc.data().Banderas;
                    if(doc.data().Categoria == categoria || (categoria=="Fav" && banderas.charAt(1)) || (categoria == "Todos")){
                    var contenido = "";
                    var contenidomodal = "";
                    var banderas = "";
                    banderas = doc.data().Banderas;
                ...
                if(doc.data().Incluye){
                    ...
                    if ((categoria == doc.data().Categoria) && doc.data().Categoria == "Bebidas frias") {
                        frias += contenido;
                        friasmodal += contenidomodal;

                       

                    }else if ((categoria == doc.data().Categoria) && doc.data().Categoria == "Bebidas calientes") {
                        calientes += contenido;
                        calientesmodal += contenidomodal;

                        
                       
                        
                    }else if ((categoria == doc.data().Categoria) && doc.data().Categoria == "Desayuno de autor") {
                        autor += contenido;
                        autormodal += contenidomodal;

                        
                       
                        
                    }else if ((categoria == doc.data().Categoria) && doc.data().Categoria == "Platillos de escritor") {
                        escritor += contenido;
                        escritormodal += contenidomodal;

                        
                        
                        
                    }else if ((categoria == doc.data().Categoria) && doc.data().Categoria == "Menu literario") {
                        literario += contenido;
                        literariomodal += contenidomodal;

                        
                        
                    }else if ((categoria == doc.data().Categoria) && doc.data().Categoria == "Postres") {
                        postres += contenido;
                        postresmodal += contenidomodal;

                        
                       
                    }else if ((categoria == doc.data().Categoria) && doc.data().Categoria == "Comida rapida") {
                        rapida += contenido;
                        rapidamodal += contenidomodal;

                        
                      
                        
                    }else if ((categoria == doc.data().Categoria) && doc.data().Categoria == "Tortas") {
                        tortas += contenido;
                        tortasmodal += contenidomodal;

                        
                       
                        
                    }else if ((categoria == doc.data().Categoria) && doc.data().Categoria == "Tacos") {
                        tacos += contenido;
                        tacosmodal += contenidomodal;

                        
                       
                        
                    }else if ((categoria == doc.data().Categoria) && doc.data().Categoria == "Barra fria") {
                        barrafria += contenido;
                        barrafriamodal += contenidomodal;

                        
                       
                        
                    }else if ((categoria == doc.data().Categoria) && doc.data().Categoria == "Vegetariano") {
                        vegetariano += contenido;
                        vegetarianomodal += contenidomodal;

                        
                        
                        
                    }else if (categoria == "Fav" && banderas.charAt(1)){
                        favoritos += contenido;
                        favoritosmodal += contenidomodal;
        ...
        doccomida.then(function(alimentos) {
            ...
            if(doc.data().Incluye){
                ...
                /*if (doc.data().Categoria == "Bebidas frias") {
                    frias += contenido;
                    friasmodal += contenidomodal;
                }else if (doc.data().Categoria == "Bebidas calientes") {
                    calientes += contenido;
                    calientesmodal += contenidomodal;
                }else if (doc.data().Categoria == "Desayuno de autor") {
                    autor += contenido;
                    autormodal += contenidomodal;
                }else if (doc.data().Categoria == "Platillos de escritor") {
                    escritor += contenido;
                    escritormodal += contenidomodal;
                }else if (doc.data().Categoria == "Menu literario") {
                    literario += contenido;
                    literariomodal += contenidomodal;
                }else if (doc.data().Categoria == "Postres") {
                    postres += contenido;
                    postresmodal += contenidomodal;
                }else if (doc.data().Categoria == "Comida rapida") {
                    rapida += contenido;
                    rapidamodal += contenidomodal;
                }else if (doc.data().Categoria == "Tortas") {
                    tortas += contenido;
                    tortasmodal += contenidomodal;
                }else if (doc.data().Categoria == "Tacos") {
                    tacos += contenido;
                    tacosmodal += contenidomodal;
                }else if (doc.data().Categoria == "Barra fria") {
                    barrafria += contenido;
                    barrafriamodal += contenidomodal;
                }else if (doc.data().Categoria == "Vegetariano") {
                    vegetariano += contenido;
                    vegetarianomodal += contenidomodal;
                }*/
                ...
                if(!nuevo){
                    ...
                    if(imagen[0] == undefined){
                        ...
                        var metadata = {
                          ...
                          var storageRef = storage.ref('');
                          var uploadTask = storageRef.child('img/' + imagen[0].name).put(imagen[0], metadata);
